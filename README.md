...
**Status: 🏗️ v1 in progress — step 3 (i18n layer) done.** The site is bilingual: persisted PT/EN switching, dictionaries with test-enforced key parity ([i18n report](docs/reports/2026-06-11-i18n.md)). Next: components (roadmap v1 step 5), pending review.
...
| [Reports](docs/reports/)                       | Per-step implementation reports ([scaffolding](docs/reports/2026-06-11-scaffolding.md) · [content layer](docs/reports/2026-06-11-content-layer.md) · [i18n](docs/reports/2026-06-11-i18n.md)) |
