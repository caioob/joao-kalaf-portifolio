...
| `--rect-h-1`        | `22rem`           | Project card — tall rectangle (cycle index 0, 3, …) |
| `--rect-h-2`        | `16rem`           | Project card — medium rectangle (cycle index 1, 4, …) |
| `--rect-h-3`        | `11rem`           | Project card — short rectangle (cycle index 2, 5, …) |
